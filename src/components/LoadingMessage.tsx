...
export const LoadingMessage: React.FC = () => {
  return (
    <div className="flex gap-4 mb-6" role="status" aria-live="polite" aria-label="AI is processing your message">
      ...
      <div className="flex-1 max-w-4xl">
        ...
        <div className="text-xs text-gray-500 dark:text-gray-400 mt-2 font-medium" aria-label="Message source">
          AI by VS • Processing...
        </div>
      </div>
    </div>
